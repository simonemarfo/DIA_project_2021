...
\begin{document}
    ...
    \addcontentsline{toc}{section}{Step 4 - Learning price for racing skis with purchase simulation}
	\input{Files/n4}	
    %---
    ...
    \addcontentsline{toc}{section}{Step 7 - Pricing and Matching: Sliding-Window}
	\input{Files/n7}	
    %---
